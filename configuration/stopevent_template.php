...
$mapper = array();
$mapper['timestamp'] = [ "r" => "%%%REQUEST_TIMESTAMP%%%", "w" => date('c')];
...
<form id="usrform">
    StopPointRef:
    <input type="text" id="bpuic" required>  (e.g. 8507000) <br>
    ...
    <br>
    IncludeOnwardCalls
    <input type="checkbox" id="bOC"/>
    <br>
    IncludeRealtimeData
    <input type="checkbox" id="bRT"/>
    <br>

    Your API-Key (obtain it <a href="https://opentransportdata.swiss/dev-dashboard/">here</a>):
    <input type="text" id="apikey" required>
    <br>

    <input type="button" value="Search StopEvent for now" onClick="doStopRequest('timestamp', 'bpuic','time','type','bPC','bOC','bRT','limit',''req','status','resp','jresp','apikey')">
    <p>
        Request:
    <p>
